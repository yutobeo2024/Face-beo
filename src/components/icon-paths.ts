/** Dữ liệu icon nét (stroke) 24px — file .ts thuần để lib/validators và test nhập được mà không cần JSX. */
export const ICON_PATHS: Record<string, string> = {
  ...
  // Icon cho thư viện liên kết ("Thông tin")
  ...
  table: "M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5ZM3 9h18M3 15h18M9 3v18M15 3v18",
  ...
  presentation: "M2 3h20M4 3v12a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V3M12 16v5M8 21l4-5 4 5",
};

export type IconName = keyof typeof ICON_PATHS;
/** Mọi tên icon hợp lệ (dùng để kiểm tra dữ liệu gửi lên server). */
export const ICON_NAMES = Object.keys(ICON_PATHS) as IconName[];

/** Icon gợi ý cho ô liên kết trong mục "Thông tin". */
export const LINK_ICONS: IconName[] = ["link", "globe", "table", "folder", "file", "book", "grid", "chart", "presentation", "video", "chat", "mail", "phone", "calendar", "users", "star", "cart", "briefcase", "map", "info", "settings", "shield"];

/** Tông màu ô liên kết: nền nhạt + chữ đậm (class tĩnh để Tailwind giữ lại). */
...
export const LINK_COLOR_NAMES = Object.keys(LINK_COLORS) as LinkColor[];
