...
export function useDepartments() {
  return useApi<{ departments: (Dept & { managerId: number | null; manager: { name: string; code: string } | null; employeeCount: number; totalEmployeeCount: number })[] }>("/api/departments");
}
