...
- Phiên bản hiện tại: **v1.10.3** (tag GitHub `v1.10.3`, repo `yutobeo2024/Face-beo`). Phiên bản ghi trong prose (README, PRD,
...
- D6 sao lưu ra ngoài VPS (rclone → R2/Drive) — **tạm hoãn theo chủ dự án 21/09/2026**, nhắc lại khi rảnh; D7 đổi token tunnel + OA Secret Key webhook (đã lộ trong ảnh chụp 21/09/2026).
